...
def test_0():
    ...
    helper("../dist/divvy_2013_stations.csv", "../dist/divvy_2013_trips_tiny.csv", ev)
...
def test_1():
    ...
    helper("../dist/divvy_2013_stations.csv", "../dist/divvy_2013_trips_small.csv", ev)
...
def test_2():
    ...
    helper("../dist/divvy_2013_stations.csv", "../dist/divvy_2013_trips_medium.csv", ev)
